...
::com::soul::gaming::Rong_obj::__register();
::com::soul::gaming::Paddle_obj::__register();
::com::soul::gaming::Game_obj::__register();
::com::soul::gaming::GameState_obj::__register();
...
::com::soul::gaming::Ball_obj::__register();
::com::soul::gaming::GameObject_obj::__register();
...
::com::soul::gaming::GameObject_obj::__boot();
::com::soul::gaming::Ball_obj::__boot();
::neash::display::InteractiveObject_obj::__boot();
::neash::display::DisplayObjectContainer_obj::__boot();
::neash::display::Sprite_obj::__boot();
::com::soul::gaming::GameState_obj::__boot();
::com::soul::gaming::Game_obj::__boot();
::com::soul::gaming::Paddle_obj::__boot();
::com::soul::gaming::Rong_obj::__boot();
