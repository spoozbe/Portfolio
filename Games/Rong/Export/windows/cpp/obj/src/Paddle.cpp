...
bool isAI = __o_isAI.Default(false);
{
	...
	HX_STACK_LINE(34)
	::Vector2 _g1 = ::Vector2_obj::__new((int)0,(int)0);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(34)
	...
	HX_STACK_LINE(40)
	::openfl::_v2::geom::Rectangle _g2 = ::openfl::_v2::geom::Rectangle_obj::__new(this->pos->x,this->pos->y,(int)10,(int)50);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(40)
	this->rect = _g2;
}
;
...
{
		HX_STACK_FRAME("Paddle","update",0xb848a96d,"Paddle.update","Paddle.hx",45,0x43ccfc74)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Paddle","playerControlDown",0x7ca2a79a,"Paddle.playerControlDown","Paddle.hx",76,0x43ccfc74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(77)
...
{
		HX_STACK_FRAME("Paddle","playerControlUp",0xd26c5793,"Paddle.playerControlUp","Paddle.hx",91,0x43ccfc74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(91)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(Paddle_obj,rect),HX_CSTRING("rect")},
	{ hx::fsUnknown, 0, null()}
};
#endif
