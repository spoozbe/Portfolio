...
{
		HX_STACK_FRAME("openfl._v2.utils.Timer","reset",0xb8c6f718,"openfl._v2.utils.Timer.reset","openfl/_v2/utils/Timer.hx",38,0x6df2932a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		if ((this->running)){
			HX_STACK_LINE(42)
...
{
		HX_STACK_FRAME("openfl._v2.utils.Timer","start",0x560a21ab,"openfl._v2.utils.Timer.start","openfl/_v2/utils/Timer.hx",53,0x6df2932a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
		if ((!(this->running))){
			HX_STACK_LINE(55)
...
Void Timer_obj::stop( ){
{
		HX_STACK_FRAME("openfl._v2.utils.Timer","stop",0x8fe23ed9,"openfl._v2.utils.Timer.stop","openfl/_v2/utils/Timer.hx",64,0x6df2932a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(66)
		this->running = false;
		HX_STACK_LINE(68)
...
Float Timer_obj::get_delay( ){
	HX_STACK_FRAME("openfl._v2.utils.Timer","get_delay",0x1e69b9a3,"openfl._v2.utils.Timer.get_delay","openfl/_v2/utils/Timer.hx",87,0x6df2932a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(87)
	return this->__delay;
}
...
Float Timer_obj::set_delay( Float value){
	HX_STACK_FRAME("openfl._v2.utils.Timer","set_delay",0x01baa5af,"openfl._v2.utils.Timer.set_delay","openfl/_v2/utils/Timer.hx",92,0x6df2932a)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.utils.Timer","timer_onTimer",0x6948e2b5,"openfl._v2.utils.Timer.timer_onTimer","openfl/_v2/utils/Timer.hx",115,0x6df2932a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(117)
		(this->currentCount)++;
		HX_STACK_LINE(119)
